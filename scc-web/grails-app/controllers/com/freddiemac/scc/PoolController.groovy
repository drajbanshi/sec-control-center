...
class PoolController {
    ...
    def search(PoolSearch poolSearch) {
        ...
        def poolErrorField = ""
        def pageFunction 
        if (params.pageFunction==null || params.pageFunction=="") {
            pageFunction = "Collapse"
        } else {
        ...
        if(poolSearch.hasErrors()) {
            ...
            if (pageFunction.equalsIgnoreCase("Collapse")) 
            ...
            else if (pageFunction.equalsIgnoreCase("Dissolve")) 
