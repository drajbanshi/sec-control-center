...
<body>
	...
	<div class="container-fluid">
		<ul class="nav nav-tabs">
			...
			<li role="presentation" class="active"><a href="#">Pool
					Detail</a></li>
		...
		<div class="tabBody">
			...
			<g:form controller="pool" action="search" class="form-inline">
				...
				<span
					...
					<input type="text" id="poolNumber" maxlength="8" size="8"
					class="form-control" name="poolNumber" aria-label="Enter Pool ID"
					value="${fieldValue(bean:poolSearch,field:'poolNumber')}">
				</span>  &nbsp;                                
				<label> ${message(code: 'PoolDetails.page.input.securitycusipidentifier')}:
				</label>
				<span
					class='value ${hasErrors(bean:poolSearch,field:'cusipIdentifier','errors')}'>
					<input type="text" id="cusipIdentifier" maxlength="9" size="9"
				...
				<span><button class="btn btn-primary" id="searchBtn"
						type="submit">
