...
com.freddiemac.searchpool.result.elements=["Loan.LoanAmortizationType","LoanPosition.LoanGrossUPBAmount","Pool.PoolIdentifier","MBS.MBSPoolPrefixCode","FinancialInstitution.ABARoutingAndTransitIdentifier","FinancialInstitutionAccount.FinancialInstitutionAccountSubaccountName","Organization.OrganizationName","FinancialInstitution.FinancialInstitutionTelegraphicAbbreviationName","SecurityWire.SecurityWireFaceValueAmount","Security.SecurityCUSIPIdentifier","SecurityIssuance.SecurityIssueDate","Security.ContractualMaturityDate","SecurityActivity.SecurityCouponRate","FinancialInstitutionAccount.FinancialInstitutionAccountIdentifier","SecurityActivity.SecurityBeneficiaryDate","SecurityActivity.SecurityStatusType"]
<<<<<<< Upstream, based on origin/master
com.freddiemac.searchpool.result.xfields=["LoanRelationship.LoanRoleType","LoanPurchaseContract.ContractGuarantyFeeRate","MBS.MBSAmortizationType","MBSDisclosure.MBSBalloonTermCount","MBS.InterestOnlyTermCount","MBS.MBSExecutionMethodType","LoanPurchaseContract.ContractExecutionMethodType","Security.FederalReserveSecurityClassCode","Security.FederalReserveSecurityDescription","SecurityIssuance.SecurityIssueFaceAmount","Security.SecurityFirstPaymentDate","Security.MinimumTradeDenominationAmount","Security.AssetBackedSecurityType","GuarantyFeeGrid.ProgramIdentifier","LoanPaymentRate.LoanInvestorPassThroughRate","SecurityActivity.SecurityRecordDate","MBSDisclosure.MBSInterestPaymentFactorRate","CollateralGroup.SecuritizationTrustIdentifier","Security.SecurityPayingAgentIdentifier","SecurityActivity.SecurityTaxRecordDate","BulkLoanPurchaseDeal.SecurityIssuerIdentifier","ContractCounterparty.PartyRoleType","AbilityToRepayExemption.LoanIdentifier","CashTransferInstruction.CashTransferInstructionIdentifier","FinancialInstrument.FinancialInstrumentType","LoanServicingTerms.LoanInvestorRemittanceType"]
=======
com.freddiemac.searchpool.result.extrafields=["Loan.LoanAmortizationType","LoanPosition.LoanGrossUPBAmount","Pool.PoolIdentifier","MBS.MBSPoolPrefixCode","FinancialInstitution.ABARoutingAndTransitIdentifier","FinancialInstitutionAccount.FinancialInstitutionAccountSubaccountName","Organization.OrganizationName","FinancialInstitution.FinancialInstitutionTelegraphicAbbreviationName","SecurityWire.SecurityWireFaceValueAmount","Security.SecurityCUSIPIdentifier","SecurityIssuance.SecurityIssueDate","Security.ContractualMaturityDate","SecurityActivity.SecurityCouponRate","FinancialInstitutionAccount.FinancialInstitutionAccountIdentifier","SecurityActivity.SecurityBeneficiaryDate","SecurityActivity.SecurityStatusType"]
>>>>>>> c9ea8e0 connection to sec mgr db
